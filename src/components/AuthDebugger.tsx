    ...
    <div className="fixed bottom-0 right-0 w-full sm:w-96 h-96 bg-gray-900/95 text-white z-50 flex flex-col rounded-t-lg overflow-hidden">
      ...
      <div className="overflow-auto p-3 text-xs flex-grow">
        ...
        <div className="bg-gray-800 p-2 rounded mb-3">
          <div>
            <span className="text-blue-400">isLoggedIn:</span>{" "}
            {isLoggedIn.toString()}
          </div>
          <div>
          ...
          <div>
            <span className="text-blue-400">User ID:</span> {user?.id || "none"}
          </div>
          <div>
          ...
          <div>
            <span className="text-blue-400">Has profile:</span>{" "}
            {!!profile ? "true" : "false"}
          </div>
          {profile && (
            <>
              ...
              <div>
                ...
                {profile.freedom_ai_credits}
              </div>
              <div>
                <span className="text-blue-400">Referral Code:</span>{" "}
